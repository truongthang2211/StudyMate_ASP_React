...
function ListCourse() {
  ...
  }, [maintypeId, postData, subtypeId, url]);
      ...
      <div className="slider container">
        <div className="row">
          <div className="col-lg-3 menu-left-new">
            <ul className="menu">
              <li>
                <Link to="/list-course/1111/null">
                  <i className="fa fa-language"></i>Ngoại ngữ
                </Link>
              ...
              <li>
                <Link to="/list-course/1112/null">
                  <i className="fa fa-line-chart"></i>Marketing
                </Link>
                <div className="megadrop">
                  <div className="col">
                    <ul>
                      <li>
                        <Link to="/list-course/null/1116">
                          Marketing Online
                        </Link>
                      </li>
                      <li>
              ...
              <li>
                <Link to="/list-course/1113/null">
                  <i className="fa fa-desktop"></i>Tin học văn phòng
                </Link>
                <div className="megadrop">
                  <div className="col">
                    <ul>
              ...
              <li>
                <Link to="/list-course/1114/null">
                  <i className="fa fa-paint-brush"></i>Thiết kế
                </Link>
                <div className="megadrop">
                  <div className="col">
                    <ul>
                      <li>
                        <Link to="/list-course/null/1127">
                          Thiết kế quảng cáo
                        </Link>
                      </li>
                      <li>
                        <Link to="/list-course/null/1128">
                          Phần mềm thiết kế
                        </Link>
                      </li>
                      <li>
              ...
              <li>
                <Link to="/list-course/1115/null">
                  <i className="fa fa-rocket"></i>Kinh doanh - Khởi nghiệp
                </Link>
                <div className="megadrop">
                  <div className="col">
                    <ul>
                      ...
                      <li>
                        <Link to="/list-course/null/1137">
                          Kiếm tiền Online
                        </Link>
                      </li>
                      <li>
                        <Link to="/list-course/null/1138">
              ...
              <li>
                <Link to="/list-course/1116/null">
                  <i className="far fa-lightbulb"></i>Phát triển cá nhân
                </Link>
                <div className="megadrop">
                  <div className="col">
                    <ul>
                      <li>
                        <Link to="/list-course/null/1144">
                          Thương hiệu cá nhân
                        </Link>
                      </li>
                      <li>
                        <Link to="/list-course/null/1145">
                          Tài chính cá nhân
                        </Link>
                      </li>
                      <li>
                      ...
                      <li>
                        <Link to="/list-course/null/1147">
                          Kỹ năng lãnh đạo
                        </Link>
                      </li>
                      <li>
                        <Link to="/list-course/null/1148">
                          Quản trị nhân sự
                        </Link>
                      </li>
                      <li>
              ...
              <li>
                <Link to="/list-course/1117/null">
                  <i className="fa fa-shopping-cart"></i>Sales, bán hàng
                </Link>
                <div className="megadrop">
                  <div className="col">
                    <ul>
                      ...
                      <li>
                        <Link to="/list-course/null/1158">
                          Bán hàng livestream
                        </Link>
                      </li>
                      <li>
                        <Link to="/list-course/null/1159">
                          Chăm sóc khách hàng
                        </Link>
                      </li>
                      <li>
                        <Link to="/list-course/null/1160">
                          Chiến lược bán hàng
                        </Link>
                      </li>
                    </ul>
              ...
              <li>
                <Link to="/list-course/1118/null">
                  <i className="fa fa-code"></i>Công nghệ thông tin
                </Link>
                <div className="megadrop">
                  <div className="col">
                    <ul>
              ...
              <li>
                <Link to="/list-course/1119/null">
                  <i className="fa fa-heartbeat"></i>Sức khỏe - Giới tính
                </Link>
                <div className="megadrop">
                  <div className="col">
                    <ul>
              ...
              <li>
                <Link to="/list-course/1120/null">
                  <i className="fa fa-cutlery"></i>Phong cách sống
                </Link>
                <div className="megadrop">
                  <div className="col">
                    <ul>
              ...
              <li>
                <Link to="/list-course/1121/null">
                  <i className="fa fa-child"></i>Nuôi dạy con
                </Link>
                <div className="megadrop">
                  <div className="col">
                    <ul>
              ...
              <li>
                <Link to="/list-course/1122/null">
                  <i className="fa fa-group"></i>Hôn nhân &amp; Gia đình
                </Link>
                <div className="megadrop">
                  <div className="col">
                    <ul>
                      <li>
                        <Link to="/list-course/null/1191">
                          Hạnh phúc gia đình
                        </Link>
                      </li>
                      <li>
                        <Link to="/list-course/null/1192">
                          Đời sống vợ chồng
                        </Link>
                      </li>
                    </ul>
              ...
              <li>
                <Link to="/list-course/1123/null">
                  <i className="fa fa-camera"></i>Nhiếp ảnh, dựng phim
                </Link>
                <div className="megadrop">
                  <div className="col">
                    <ul>
